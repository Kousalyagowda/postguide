...
<!-- Mirrored from lifesthtml.websitelayout.net/video.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jul 2022 07:11:59 GMT -->
<head>
    <!-- metas -->
    <meta charset="utf-8" />
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    ...
                                    <div class="attr-nav align-items-lg-center ms-lg-auto main-font">
                                        <ul>
                                            ...
                                            <li class="d-none d-xl-inline-block"><a href="contact.html" class="butn text-white md">Free Quote</a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <ul class="ps-0">
                                ...
                                <li><a href="#!" class="text-white">Responsive Video</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="mb-6 mb-lg-8 position-relative elements-block">
                            ...
                            <div class="inner-title">
                                <h2 class="h4 mb-0">Youtube Iframe Video</h2>
                            </div>
...
&lt;iframe class="w-100 height-300" src="https://youtu.be/zltSmOEFI_A" allow="encrypted-media" allowfullscreen&gt;&lt;/iframe&gt;
&lt;!-- end iframe video section --&gt;
                    </code></pre>
                            </div>
                        ...
                        <div class="mb-6 mb-lg-8 position-relative elements-block">
                            ...
                            <div class="inner-title">
                                <h2 class="h4 mb-0">Youtube Video</h2>
                            </div>

                            <!-- youtube video section -->
                            <div class="height-300">

                                <div class="story-video bg-img cover-background h-100" data-overlay-dark="0" data-background="img/bg/bg-03.jpg">
...
&lt;/div&gt;
                        ...
                        <div class="position-relative elements-block">
                            ...
                            <div class="inner-title">
                                <h2 class="h4 mb-0">Vimeo Video</h2>
                            </div>
