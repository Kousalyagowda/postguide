            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="ps-xl-3">
                            <h2 class="h3 mb-4">CHOOSE INSURANCE TYPE</h2>
                            <form action="insurance.php" method="post" enctype="multipart/form-data" onclick="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <div class="quform-input">
                                                    <input id="phone" type="radio" name="type" value="Degree holder"  required="" />Degree holder
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <div class="quform-input">
                                                    <input id="phone" type="radio" name="type" value="Government job holder" required=""  />Government job holder
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <div class="quform-input">
                                                    <input id="phone" type="radio" name="type" value="Old age" required="" />Old age
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <div class="quform-input">
                                                    <input id="phone" type="radio" name="type" value="other" placeholder="Your phone here" required="" />Other
                                                </div>
                                            </div>
                                        </div>
