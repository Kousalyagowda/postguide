            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="ps-xl-3">
                            <h2 class="h3 mb-4">FEEDBACK</h2>
                            <form  action="../controller/feedback.php" method="post" enctype="multipart/form-data" onclick="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <input class="form-control" id="email" type="text" name="email" placeholder="Your email here" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="" />
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <input class="form-control" id="email" type="text" name="pincode" placeholder="Your Pin here" pattern="[0-9]+"  minlength="6" maxlength="6"  title="enter valid number" required="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="email">Your Feedback <span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                                    <textarea class="form-control" id="email" type="text" name="feedback" placeholder="Your feedback here" required="" /></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Text input element -->
