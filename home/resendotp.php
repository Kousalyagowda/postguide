                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="phone">Check your mail to get OTP</label>
                                                <div class="quform-input">
                                                    <input class="form-control" id="phone" type="text" name="otp" placeholder="Please Enter Your OTP" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-submit-inner">
                                                <button class="butn border-0" name="sub" type="submit">Submit</button>
                                            </div>
                                        ...
                                        <form action="../phpmailer/resendotp.php" method="post">
                                        <div class="col-md-12">
                                            <div class="quform-submit-inner">
                                            <input class="form-control" id="phone" value="<?php echo $_SESSION['email'] ?>" type="hidden" name="mail" placeholder="Your mail here" />

                                                <button class="butn border-0" name="re" type="submit">Re-send otp</button>
                                            </div>
                                            <div class="quform-loading-wrap text-start"><span class="quform-loading"></span></div>
                                        </div>
                                        </form>
