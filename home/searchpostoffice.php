      ...
      <?php include 'header.php' ?>
        ...
        <section>
            <div class="container">
                    ...
                    <h2 class="display-22 display-sm-18 display-md-16 display-lg-11 mb-0">POST-OFFICE SEARCH </h2>
                <br><br><br>
                <div class="row g-lg-5 mt-n2-9">

              
<form role="search" id="form" action="searchpostoffice.php" method="POST">
    ...
    <svg viewBox="0 0 1024 1024"><path class="path1" d="M848.471 928l-263.059-263.059c-48.941 36.706-110.118 55.059-177.412 55.059-171.294 0-312-140.706-312-312s140.706-312 312-312c171.294 0 312 140.706 312 312 0 67.294-24.471 128.471-55.059 177.412l263.059 263.059-79.529 79.529zM189.623 408.078c0 121.364 97.091 218.455 218.455 218.455s218.455-97.091 218.455-218.455c0-121.364-103.159-218.455-218.455-218.455-121.364 0-218.455 97.091-218.455 218.455z"></path></svg>
                                                        ...
                                                        if(isset($_POST['q'])){
                                                          ...
                                                          $dist=$_POST['q'];
                                                            ...
                                                            $stm=$admin->ret("SELECT * FROM `postoffice`  WHERE `postbranch`='$dist' OR `pincode`='$dist' OR `district`='$dist'  ");
                    ...
                    <div class="col-md-6 col-lg-4 mt-2-9 wow fadeIn" data-wow-delay="200ms">
                        <div class="card-style1">
                            <div class="card-image position-relative">
                                <img src="../image/<?php echo $post['postimg'] ?>" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body p-1-6 p-sm-1-9 pt-2-3 position-relative">
                                ...
                                <h3 class="h4 mb-3"><a href="#"><?php echo $post['postbranch'] ?></a></h3>
                                <h4 class="h4 mb-3"><?php echo $post['pincode'] ?></h4>
                                <p class="mb-4"><?php echo $post['address'] ?></p>
                                <p class="mb-4"><?php echo $post['contact'] ?></p>
                                <p class="mb-4"><a href="<?php echo $post['location'] ?>" class="btn btn-primary">click here to view location</a></p>
