            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="ps-xl-3">
                            <h2 class="h3 mb-4">DEPOSITE SERVICE</h2>
                            <form  action="../controller/posbdeposit.php" method="post" enctype="multipart/form-data" onclick="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="email">Deposit branch<span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                                    <input class="form-control" id="email" type="text" name="branch" placeholder="Deposit branch" required="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <input class="form-control" id="email" type="text" name="pin" placeholder="Enter pincode" pattern="[0-9]+"  minlength="6" maxlength="6"  title="enter valid number" required="" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="email">Enter amount <span class="quform-required">*</span></label>
                                                <div class="quform-input">
