            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="ps-xl-3">
                            <h2 class="h3 mb-4">ENTER THE TRACKID</h2>
                            <form  action="trackservice.php" method="post" enctype="multipart/form-data" onclick="">
                                <div class="quform-elements">
                                    <div class="row">
                                        
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="phone">Check your mail to get the trackid</label>
                                                <div class="quform-input">
                                                    <input class="form-control" id="phone" type="text" name="trackid" placeholder="Please Enter Your Trackid" />
                                                </div>
                                            </div>
                                        </div>
