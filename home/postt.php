            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="ps-xl-3">
                            <h1 class="h3 mb-4"><u>Choose Post type</u></h1>
                            <form action="../controller/posttype.php" method="post" enctype="multipart/form-data" onclick="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <div class="quform-input">
                                                    <h4><input id="phone" type="radio" name="type" value="speedpost" placeholder="Your phone here" checked /><b>Speed Post</b></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <div class="quform-input">
                                                    <h4><input id="phone" type="radio" name="type" value="RegisterPost" placeholder="Your phone here" /><b>Register Post</b></h4>
                                                </div>
                                            </div>
                                        </div>

                                        <h5>For Register post:Rs.50/-</h5>
                                        <h5>For speed post:Rs.100/-</h5>
                                        <div class="col-md-12">
