                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h2 class="m-b-10">MANAGE INSURANCE REQUESTS</h2>
                                            <h4 class="m-b-0">Details of insurance requests</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-inverse">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $stmt = $admin->ret("SELECT * FROM  `insurance_req`  WHERE `pincode`=$pincode ");
                                                            $i=1;
                                                            while ($post1 = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                $insid = $post1['ins_id'];
                                                                $uid = $post1['u_id'];
                                                                $stmt1 = $admin->ret("SELECT * FROM `insurance` WHERE `ins_id`='$insid'");
                                                                $post5 = $stmt1->fetch(PDO::FETCH_ASSOC);
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $post1['adhar_no'] ?></td>
                                                                    <td><?php echo $post3['ph_no'] ?></td>
                                                                    <td><?php echo $post5['ins_name'] ?></td>
                                                                    <td><a href="../image/<?php echo $post1['birth_certificate'] ?>" class="btn btn-primary">Birth certificate</a> </td>
                                                                    <td><a href="../image/<?php echo $post1['certificate'] ?>" class="btn btn-primary">certificate</a> </td>
                                                                    <td><a href="../image/<?php echo $post1['voter_id'] ?>" class="btn btn-primary">voter id</a> </td>

                                                                    <!-- <?php  if($row4['status'] == 0) { ?> -->

                                                                        <!-- <td> <a href="../controller/ia.php?sid=<?php echo $row4['sr_id'] ?>&S=1" class="badge bg-success">Approve</a> </td> -->

                                                                        <!-- <td> <a href="../controller/ia.php?sid=<?php echo $row4['sr_id'] ?>&S=2" class="badge bg-danger">Reject</a> </td> -->
