                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h2 class="m-b-10">VIEW COMPLAINTS INFORMATION</h2>
                                            <h4 class="m-b-0">Details of complaint</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                    ...
                                                    <table class="table table-inverse">
                                                        ...
                                                        <tbody>
                                                           ...
                                                           $post=$stm->fetch(PDO::FETCH_ASSOC);
                                                            ...
                                                            $stmt=$admin->ret("SELECT * FROM  `user_feedback`  WHERE `pincode`=$pincode ");
                                                            while ($post1=$stmt->fetch(PDO::FETCH_ASSOC)){
                                                               
                                                                         ?>
                                                            <tr>
                                                                <th scope="row"><?php echo $post1['feedback_id']?></th>
                                                                <td><?php echo $post1['user_name']?></td>
                                                                <td><?php echo $post1['feedback']?></td>
