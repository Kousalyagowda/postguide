                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h2 class="m-b-10">MANAGE WITHDRAWAL REQUESTS</h2>
                                            <h4 class="m-b-0">Details of withdraw request</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-inverse">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $stmt = $admin->ret("SELECT * FROM `withdraw` WHERE `pincode`='$pincode' ");
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $post1['withdraw_amt'] ?></td>
                                                                  
                                                                    <td><?php echo $post1['acc_no'] ?></td>
                                                                    <td><?php echo $post1['ifsc_code'] ?></td>
                                                                    <?php if ($row4['status'] == 0) { ?>

                                                                        <td> <a href="../phpmailer/send_ref.php?sid=<?php echo $row4['sr_id'] ?>&S=1" class="badge bg-success">Approve</a> </td>

                                                                        <td> <a href="../phpmailer/send_ref.php?sid=<?php echo $row4['sr_id'] ?>&S=2" class="badge bg-danger">Reject</a> </td>
