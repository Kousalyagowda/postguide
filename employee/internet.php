                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h2 class="m-b-10">MANAGE INTERNET BANKING</h5>
                                            <h4 class="m-b-0">Details of interent banking requests</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-inverse">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $stmt = $admin->ret("SELECT * FROM `internetbank` WHERE `pincode`='$pincode' ");
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <?php if ($row4['status'] == 0) { ?>
                                                                        ...
                                                                        <td> <a href="../controller/aint.php?sid=<?php echo $row4['sr_id'] ?>&S=1" class="badge bg-success">Approve</a> </td>

                                                                        <td> <a href="../controller/aint.php?sid=<?php echo $row4['sr_id'] ?>&S=2" class="badge bg-danger">Reject</a> </td>
