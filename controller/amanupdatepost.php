...
$update=$admin->cud("UPDATE `postoffice` SET `address`='$address',`pincode`='$pincode',`postimg`='$postimg',`location`='link',`contact`='$postphno',`postbranch`='$postbranch'   WHERE postoffice.postid='$id'","sucessfully updated information");
